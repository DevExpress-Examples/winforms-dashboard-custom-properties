...
Namespace WindowsFormsAppCustomProperties
    ...
    Public Class GridFixedColumnModule
        ...
        Public Sub New(ByVal designer As DashboardDesigner, ByVal Optional barImage As SvgImage = Nothing)
            ...
            Dim barItem As BarButtonItem = Me.CreateBarItem("Fix Columns", barImage)
            group.ItemLinks.Add(barItem)
            barItem.ItemClick += AddressOf ChangeCustomPropertyValue
        ...
        Private Sub ChangeCustomPropertyValue(ByVal sender As Object, ByVal e As ItemClickEventArgs)
            ...
            Dim control As ColumnSelectorControl = New ColumnSelectorControl(checkedColumnsList)
            If XtraDialog.Show(control, "Select columns to fix:") = DialogResult.OK Then
                For Each item In checkedColumnsList
                    If Convert.ToBoolean(item.Column.CustomProperties.GetValue(PropertyName)) <> item.Checked Then
                        ...
                        Dim historyItem As CustomPropertyHistoryItem = New CustomPropertyHistoryItem(item.Column, PropertyName, item.Checked.ToString(), $"{status} the {item} column")
    ...
    Public Class ColumnSelectorControl
        ...
        Private checkedCombo As CheckedListBoxControl = New CheckedListBoxControl()
        ...
        Public Sub New(ByVal gridColumns As List(Of CheckedComboBoxItem))
            ...
            Me.checkedCombo.ItemCheck += AddressOf CheckedCombo_ItemCheck
